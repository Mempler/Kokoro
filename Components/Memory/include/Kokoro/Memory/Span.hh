...
// Various feature test macros
    ...
    #define TCB_SPAN_NAMESPACE_NAME Kokoro::Memory
#endif
...
// Reimplementation of C++17 std::size() and std::data()
    ...
    class Span
    {
      ...
      public:
        ...
        TCB_SPAN_CONSTEXPR_ASSIGN Span& operator=(
    ...
    template <typename ElementType, std::size_t Extent>
    constexpr Span<ElementType, Extent> MakeSpan(
    ...
    template <typename T, std::size_t N>
    TCB_SPAN_ARRAY_CONSTEXPR Span<T, N> MakeSpan(
    ...
    template <typename T, std::size_t N>
    TCB_SPAN_ARRAY_CONSTEXPR Span<const T, N> MakeSpan(
    ...
    template <typename Container>
    constexpr Span<const typename Container::value_type> MakeSpan(
    ...
    template <class ElementType, size_t Extent,
              typename std::enable_if<!std::is_const<ElementType>::value,
                                      int>::type = 0>
    Span<byte,
         ( ( Extent == dynamic_extent ) ? dynamic_extent
                                        : sizeof( ElementType ) * Extent )>
